...
namespace TableReservation
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            ILogger logger = _loggerFactory.CreateLogger<TableReservationBot>();
            ...
            services.AddSingleton<TableReservationAccessors>(sp =>
            {
                ...
                var accessors = new TableReservationAccessors(userState)
                {
                    WelcomeUserState = userState.CreateProperty<WelcomeUserState>(TableReservationAccessors.WelcomeUserName),
                };
